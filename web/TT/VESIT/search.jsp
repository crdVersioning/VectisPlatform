...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/Vectis/TT/VESIT/search.css">
        <link rel="icon" href="/Vectis/RESOURCES/TRANS_LOGO.png" type="image/png" />
    </head>
    <body>
        <%if(!session.isNew()){%>
        <div id="pageHeader">
            <span id="headerTitle">VESIT TRACK&TRACE</span>
            <img id="customerLogo" src="/Vectis/RESOURCES/VESIT_LOGO.png">
        ...
        <div id="searchBox">
            <div id="singleTrack">
                ...
                <input id="ddtNumber" placeholder="NUMERO BOLLA" onkeydown="if(event.keyCode===13)APP.searchSingleTrack();">
                <input id="customerRef" placeholder="RIFERIMENTO CLIENTE" onkeydown="if(event.keyCode===13)APP.searchSingleTrack();">
    ...
    <script>
        ...
        {
            let ddtNumber = document.getElementById("ddtNumber").value;
            let customerRef = document.getElementById("customerRef").value;
            window.open("singletrack.jsp?&customerRef="+customerRef+"&ddtNumber="+ddtNumber,"_blank");
        };

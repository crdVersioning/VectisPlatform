...
<%
    ...
    if(
        ...
        || (ddtNumber!=null && !ddtNumber.isEmpty())
        || delivery_key!=null) try
    {
        delivery = dbi.read("replica.view_Shipments_VESIT")
    ...
    String carrier1Code = null;
    String carrier2Code = null;
    ...
    if(delivery!=null)
    {
        ...
        carrier1Code = delivery.getString("carrier1Code");
        carrier2Code = delivery.getString("carrier2Code");
        

        if(delivery.getDate("deliveryDate")!= null  && !NULL_DATE.equals(SDF.format(delivery.getDate("deliveryDate")))) status = "CONSEGNATO";
        
        else if(CAMPANIA.contains(deliveryProvince) && travelDate!=null && carrier1Code!=null && !carrier1Code.trim().isEmpty())
            status = "IN CONSEGNA - "+SDF.format(travelDate);
            ...
            status = "IN CONSEGNA - "+SDF.format(new Date(travelDate.getTime()+(travelDate.getDay()==5?3:1)*oneDay));
        ...
        else
        {
            ...
            else if(delivery.getString("deliveryRegion")!=null) switch(delivery.getString("deliveryRegion").toUpperCase())            
            {
                case "CAMPANIA": break;
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/Vectis/TT/VESIT/singletrack.css">
    ...
    <body>
        ...
        <table id="deliveryData">
            ...
            <tbody>
                ...
                <tr><td>DATA VIAGGIO</td><td><%=delivery.getDate("travelDate")!= null && carrier1Code!=null  && !carrier1Code.trim().isEmpty() ? SDF.format(delivery.getDate("travelDate")) : "-"%></td></tr>
        ...
        <table id="historyData">
            ...
            <tbody>
                ...
                <%if(status.startsWith("IN CONSEGNA - ")){%>
                <tr>
                    <td>-</td>
                    <td><%=status.replace("IN CONSEGNA - ","")%></td>
                    <td>IN CONSEGNA</td>
                    <td>-</td>
                </tr>
                <%}%>

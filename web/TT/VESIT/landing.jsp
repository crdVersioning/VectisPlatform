...
<%
    ...
    List<String> accessCodes = Arrays.asList("TTVESIT2020");
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/Vectis/TT/VESIT/landing.css">
    ...
    <script>
        ...
        APP.login=()=>
        {
            ...
            window.open("/Vectis/TT/VESIT/landing.jsp?&accessCode="+accessCode,"_self");
        };
    </script>
    <%}else{%>
    <script>
        window.open("/Vectis/TT/VESIT/search.jsp","_self");
    </script>
    <%}%>
</html>

...
<%
    ...
    {
        delivery = dbi.read("replica.view_Shipments_SCERNI")
            .andIsEqual(customerRef!=null&&!customerRef.isEmpty(),"shipmentDocNumber",customerRef)
    ...
    if(delivery!=null)
    {
        if(customerRef==null) customerRef = delivery.getString("customerRef");
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/Vectis/TT/SCERNI/singletrack.css">
    ...
    <body>
        ...
        <div id="pageHeader">
            <span id="headerTitle">NUMERO BOLLA : <%=customerRef%></span>
        </div>
        ...
        <table id="deliveryData">
            ...
            <tbody>
                ...
                <tr><td>NUMERO BOLLA</td><td><%=delivery.getString("shipmentDocNumber")%></td></tr>

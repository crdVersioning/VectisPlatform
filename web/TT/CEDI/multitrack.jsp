<%@page import="com.dps.tt.cedi.DAO"%>
<%@page import="com.dps.tt.cedi.TrackingData"%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/Vectis/TT/CEDI/multitrack.css">
    ...
    <script>
        ...
        APP.downloadCSV=()=>
        {
            window.open("/Vectis/CediServlet/CSV?&toDate=<%=toDate.getTime()%>&fromDate=<%=fromDate.getTime()%>&region=<%=region%>");
        };
    </script>    

...
<%
    ...
    {
        delivery = dbi.read("replica.view_Shipments_HISENSE")
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/Vectis/HTT/singletrack.css">
    ...
    <body>
        ...
        <div id="pageHeader">
            <span id="headerTitle">NUMERO DI RIFERIMENTO : <%=customerRef%></span>
        </div>

<%@page import="com.dps.htt.DAO"%>
<%@page import="com.dps.htt.TrackingData"%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/Vectis/HTT/multitrack.css">
    ...
    <script>
        ...
        APP.downloadCSV=()=>
        {
            window.open("/Vectis/HTTServlet/CSV?&toDate=<%=toDate.getTime()%>&fromDate=<%=fromDate.getTime()%>&region=<%=region%>");
        };
    </script>    
